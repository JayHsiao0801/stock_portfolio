...
- **持股明細**：股數、均價、投入成本、即時現價、預估收入（扣手續費與交易稅）、損益、報酬率
...
- **退休規劃（FIRE）**：設定每月生活費目標（可點擊每月支出卡片直接編輯），計算 FIRE 達成率，各組合重點頁面同步顯示進度條
- **個股查詢**：搜尋任意股票，查看 K 線圖（1m～5y）、開高低量、本益比、EPS
- **新增持股自動搜尋**：支援台股/美股（Yahoo Finance）與陸股 A 股（Sina Finance，簡體中文 / 代號 / 拼音）兩種搜尋模式，可在設定頁切換
- **深色 / 淺色 / 系統模式**切換
